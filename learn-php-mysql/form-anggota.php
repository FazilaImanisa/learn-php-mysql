        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                if(isset($_GET["id_anggota"])){
                    // (isset) memeriksa ketika load file ini, apakah membawa data GET dengan nama "id_anggota"
                    // jika true, maka form anggota digunakan untuk edit

                    # mengakses data anggota dari id_anggota yang dikirim
                    ...
                    #konversikan hasil query ke bentuk array
                    ...
                    <button type="submit" class="btn btn-success btn-block" name="edit_anggota">
                        Simpan
                    </button>
                    </form>
                    <?php
                    ...
                    <form action="process-anggota.php" method="post">
                    ID Anggota
                    <input type="text" name="id_anggota" class="form-control mb-2" required />
                    Nama Anggota
                    <input type="text" name="nama_anggota" class="form-control mb-2" required />
                    Alamat
                    <input type="text" name="alamat" class="form-control mb-2" required />
                    Nomor Telepon
                    <input type="text" name="telepon" class="form-control mb-2" required />
                    Tanggal Lahir
                    <input type="date" name="tgl_lahir" class="form-control mb-2" required />

                    <button type="submit" class="btn btn-success btn-block" name="simpan_anggota">
                        Simpan
                    </button>
                    </form>
                    <?php
